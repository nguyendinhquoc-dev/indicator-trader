//@version=4
//Heikin Ashi
study("NDQ BB - Heikin Ashi - EMA - SAR - OBF - Pivot HL", shorttitle="BB - Heikin Ashi - EMA - SAR - OBF- Pivot HL", overlay=false)
...
////////////// ORDER BLOCK FINDER
colors    = input(title = "Color Scheme", defval="DARK", options=["BRIGHT", "DARK"])
...
plotshape(ShowHHLL ? higherhigh : na, title='HH', style=shape.triangledown, location=location.abovebar, color=colorH, text="HH", textcolor=colorH, offset=-rightLenH, display=0)
plotshape(ShowHHLL ? higherlow : na, title='HL', style=shape.triangleup, location=location.belowbar, color=colorL, text="HL", textcolor=colorL, offset=-rightLenH, display=0)
plotshape(ShowHHLL ? lowerhigh : na, title='LH', style=shape.triangledown, location=location.abovebar, color=colorH, text="LH", textcolor=colorH, offset=-rightLenL, display=0)
plotshape(ShowHHLL ? lowerlow : na, title='LL', style=shape.triangleup, location=location.belowbar, color=colorL, text="LL", textcolor=colorL, offset=-rightLenL, display=0)
...
plot(basis, "Basis", color=#FF6D00, offset = offset, display=0)
p1 = plot(upper, "Upper", color=#26a69a, offset = offset)
p2 = plot(lower, "Lower", color=#26a69a, offset = offset)
